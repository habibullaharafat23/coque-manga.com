var websitePrivacyPage = "https://coque-manga.com/politique-de-confidentialite/";
var unknownCookieText = ["Unknown", "This cookie information is unknown"];

var categoryText = ["Nécessaire", "Préférences", "Statistiques", "Commercialisation", "Non classé"];

var learnMoreText = "Learn more about the provider";

var topSectionText = ["Consentement", "Détails", "À propos"];
...
var categoryDescriptionsText = {
	Necessary: {
		description: "Les cookies nécessaires rendent le site Web utilisable en activant des fonctions de base telles que la navigation dans les pages et l'accès aux zones sécurisées du site Web. Sans ces cookies, le site Web ne peut pas fonctionner correctement",
	},
	Preferences: {
		description: "Les cookies de préférence permettent à un site Web de mémoriser des informations qui modifient le comportement ou l'apparence du site Web.",
	},
	Statistics: {
		description: "Les cookies statistiques aident les propriétaires de sites Web à comprendre comment les visiteurs interagissent avec les sites Web en collectant et en signalant des informations de manière anonyme.",
	},
	Marketing: {
		description: "Les cookies marketing sont utilisés pour suivre les visiteurs sur les sites Web. L'intention est d'afficher des publicités pertinentes et attrayantes pour l'utilisateur individuel.",
	},
	Unclassified: {
		description: "Les cookies non classés sont des cookies que nous classons actuellement en collaboration avec les fournisseurs de cookies individuels.",
	},
};
...
var websiteLogo = "https://coque-manga.com/wp-content/uploads/2020/06/cropped-logog.png";
